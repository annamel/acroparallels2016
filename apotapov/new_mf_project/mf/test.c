...
int main(void) {
    char* first_file = "test.txt";

    print_res(test_open_close(first_file), "test_open_close: ");
    printf("\n\n");

    print_res(test_file_size(first_file), "test_file_size: ");
    printf("\n\n");

    print_res(test_read(first_file), "test_read: ");
    printf("\n\n");

    print_res(test_map_unmap(first_file), "test_map_unmap: ");
    printf("\n\n");

    print_res(test_read_and_cmp(first_file), "test_read_and_cmp: ");
    printf("\n\n");

    print_res(test_write_read_cmp(first_file), "test_write_read_cmp: ");
    printf("\n\n");

    print_res(performance_test(first_file), "performance_test: ");
    printf("\n\n");
