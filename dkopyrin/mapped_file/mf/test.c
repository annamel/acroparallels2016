...
int main(int argc, char *argv[]){
	...
	LOG(DEBUG, "---Write\n");
	struct _mf *f1 = _mf_open(argv[1], O_RDONLY);
	struct _mf *f2 = _mf_open(argv[2], O_RDWR | O_CREAT | O_TRUNC, 0777);
